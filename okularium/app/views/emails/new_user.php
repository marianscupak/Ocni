<table style="width: 60%; background-color: #FF6347; margin: 0 20%; padding: 0 30px">
    ...
    <tr>
        <td>
            <h1 style="color: white; font-size: 25px">Vítejte v klinice Okularium <?= $data['user']->name . ' ' . $data['user']->surname ?>!</h1>
        </td>
    </tr>
    <tr>
        <td>
            <h2 style="color: white; font-size: 20px">Vaše přihlašovací údaje:</h2>
        </td>
    </tr>
    </tbody>
</table>
<table style="margin: 40px 20%">
    <tbody>
        <tr>
            <td>
                <b style="font-size: 20px; color: #FF6347">Email:</b> <span style="font-size: 20px"><?= $data['user']->email ?></span>
            </td>
        </tr>
        <tr>
            <td>
                <b style="font-size: 20px; color: #FF6347">Heslo:</b> <span style="font-size: 20px"><?= $data['password'] ?></span>
            </td>
        </tr>
        <tr>
            <td>
