<table style="width: 60%; background-color: #FF6347; margin: 0 20%; padding: 0 30px">
    ...
    <tr>
        <td>
            <h1 style="color: white; font-size: 25px">Aktualizace Vašeho Okularium účtu proběhla úspěšně!</h1>
        </td>
    </tr>
    </tbody>
</table>
<table style="margin: 40px 20%">
    <tbody>
        <tr>
            <td>
                <h2 style="font-size: 20px">Pokud o této akci nic nevíte, kontaktujte nás.</h2>
            </td>
        </tr>
    </tbody>
</table>
